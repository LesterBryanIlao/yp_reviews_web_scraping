...
from utils.scraping_utils import ScrapeUtil, get_more_details, convert_csv_file_to_list, get_specific_detail
...
print(services_products)
# print([name, contact_number, address, yp_rating_count, reviews_count, services_products])
